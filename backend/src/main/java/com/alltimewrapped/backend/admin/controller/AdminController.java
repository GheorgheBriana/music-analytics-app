...
public class AdminController {
    ...
    public Map<String, Object> refreshWarehouse(@RequestParam(defaultValue = "20000") int limit) {
    ...
    public Map<String, Object> triggerEnrichment(@RequestParam(defaultValue = "10") int limit) {
